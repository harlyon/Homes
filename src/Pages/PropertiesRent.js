...
class PropertiesRent extends Component {
  constructor(props) {
    super(props);
    this.ref = firebase
      .firestore()
    ...
    return (
      <div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12 text-center">
                <h1 className="mt-0 mb-3">Properties For Rent</h1>
        ...
        <section className="section-padding">
          ...
          <div className="container">
            <div className="row">
              {this.state.properties.reverse().map(item => {
                return (
                  <div key={item.key} className="col-md-4 col-lg-4">
                    <div className="card card-list">
                      ...
                      <div className="card-body">
                        ...
                        <h6 className="card-subtitle mt-1 mb-0">{item.type}</h6>
                      </div>
